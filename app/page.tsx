...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen max-w-[100rem] mx-auto">
      ...
      <div className="px-[10px] pt-12 pb-20">
        <div className="flex flex-col xl:flex-row gap-2 xl:gap-40">
          <div className="pt-12">
            <h2 className="text-2xl md:text-4xl mb-5 font-bold">
              OUR TOP PRODUCTS
            </h2>
            <p className="text-xl">You can pay to boost your products here.</p>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-2 xl:gap-12">
